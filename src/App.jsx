...
const App = () => {
  return (
    <div className='bg-[#DBD4F6] h-screen w-screen flex items-center justify-center gap-1'>
      <div className='bg-white h-full w-[95%] shadow-2xl rounded-lg flex gap-2'>
        ...
        <div className='w-[35%] h-[60%] rounded-lg mr-2 bg-[#C8B7EB] flex flex-col items-center justify-start pt-2 gap-3'>
